...
class Widget extends DmYY {
  ...
  init = async () => {
    try {
      ...
      this.campusAccess = campusAccess ? campusAccess : '';  // 新增
      this.campusBody = campusBody ? campusBody : '';        // 新增
  ...
  async getData() {
    const mainUrl = 'https://app.10099.com.cn/contact-web/api/busi/qryUserInfo';
    const campusUrl = 'https://app.10099.com.cn/contact-web/api/busi/qryUserRes';
    ...
    try {
      ...
      mainReq.method = 'POST';
      mainReq.body = JSON.stringify({ "data": this.body });
      const userInfo = await mainReq.loadJSON();
